document.addEventListener("DOMContentLoaded", function() {
    ...
    let fromValue, fromValue2, usdValue, usdValue2, toValue;
    ...
    function convertToUSD(fromValue, currency) {
        if (currency === "AED") {
    ...
    button.addEventListener("click", function getCurrency() {
        ...
        const currency3 = document.getElementById("tcurrency").value;
        fromValue = leftinput.value;
        fromValue2 = rightinput.value;
        let totalValue;

        usdValue = convertToUSD(fromValue, currency);
        usdValue2 = convertToUSD(fromValue2, currency2);
        totalValue = usdValue + usdValue2;
        toValue = convertFromUSD(totalValue, currency3);

        console.log(toValue);

        totalinput.innerHTML = toValue.toFixed(2);
    });
});